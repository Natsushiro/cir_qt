...
from trainer_cam import train
from webdata_replace import get_data
...
def main_worker(gpu, ngpus_per_node, log_queue, args):
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        train(model, img2text, mask, data, epoch, optimizer, scaler, scheduler, args, writer)
